...
CATALOGUE: dict[str, dict[str, str]] = {
    ...
    "insights.median_total": {"en": "Median key-up to typed",
                              "ru": "Медиана: от отпускания до печати"},
    ...
    "settings.shortcut_hint": {"en": "click, then press the keys you want",
                               "ru": "нажмите, затем введите нужные клавиши"},
    ...
    "settings.delivery_hint": {
        "en": "typing a long dictation takes the other app tens of seconds",
        "ru": "печать длинной диктовки занимает у чужого окна десятки секунд"},
    "settings.delivery_auto": {"en": "Automatic", "ru": "Автоматически"},
    "settings.delivery_type": {"en": "Always type", "ru": "Всегда печатать"},
    "settings.delivery_paste": {"en": "Always paste", "ru": "Всегда вставлять"},
    ...
    "settings.keep_alive_hint": {
        ...
        "ru": "сколько держать после последней диктовки: меньше времени освобождает "
    ...
    "notify.no_cleanup": {"en": "Dictation works, cleanup does not",
                          "ru": "Диктовка работает, а вычитка нет"},
